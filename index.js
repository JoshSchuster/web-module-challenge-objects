...
function getReviewByIndex(reviews, index) {
  ...
  console.log(getReviewByIndex(reviews, 0)); //test
...
*/
function getLastReview(arrayOfReviews) {
    return arrayOfReviews[arrayOfReviews.length-1].name + " gave the restaurant a " + arrayOfReviews[arrayOfReviews.length-1].rating + " star review and their feedback was: " + arrayOfReviews[arrayOfReviews.length-1].feedback;
  } 

  reviews.pop(); //remove my review so we can return Reyna's review
  console.log(getLastReview(reviews)); //test
...
*/
 ...
 function getReviewByRating(arrayOfReviews, rating) {
  let returnArray = [];
  
  for(let i = 0; i < arrayOfReviews.length; i++){
      if(arrayOfReviews[i].rating >= rating){
        returnArray.push(arrayOfReviews[i]);
      }
    }
    return returnArray;
  }

  console.log(getReviewByRating(reviews, 4)); //test
